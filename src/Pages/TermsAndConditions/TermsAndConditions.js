...
const TermsAndConditions = () => (
    <div>
        <h2 className={styles.title}>Termeni si conditii</h2>
        <h3 className={styles.subtitle}>1. Definitii</h3>
        ...
        <h3 className={styles.subtitle}>2. General</h3>
        <p className={styles.paragraph}>
        ...
        <h3 className={styles.subtitle}>3. Continut</h3>
        <p className={styles.paragraph}>
            ...
            mauris sed leo maximus posuere.
        </p>
        <h3 className={styles.subtitle}>4. Contact</h3>
        <p className={styles.paragraph}>
            Sed dui sem, gravida at sodales a, pretium dignissim dolor. Nam vel venenatis metus. Duis id nunc sagittis,
            tincidunt arcu at, feugiat nulla. Donec imperdiet tempus metus, ac ornare libero rutrum eu. Morbi et nulla
            eget neque efficitur mollis. Phasellus condimentum risus purus, nec scelerisque tellus pellentesque in.
            Quisque ipsum justo, egestas eget luctus vel, vulputate ac risus. Orci varius natoque penatibus et magnis
            dis parturient montes, nascetur ridiculus mus.
        </p>
        <h3 className={styles.subtitle}>5. Notificari</h3>
        <p className={styles.paragraph}>
